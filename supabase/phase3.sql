...
-- Return a loan: two signed steps, mirroring send_transfer / receive_transfer.
...
-- Step 2: lending branch confirms the goods are physically back (credits their stock).
